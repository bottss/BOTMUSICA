...
◪ *INFO*
  ❏ Prefixo: 「  ${prefix}  」
  ❏ Criador: LORDE_SCREAMO
◪ *SOBRE* TYO DO CAFE 
  │
  ├─ ❏ ${prefix}instagram : https://www.instagram.com/lordescreamocanal/

  ├─ ❏ ${prefix}blocklist
  ├─ ❏ ${prefix}grupo whatsapp :https://chat.whatsapp.com/KkMidKAWxZJB2zbnUyWsba
  ├─ ❏ ${prefix} numero whatsapp 5522999982383
